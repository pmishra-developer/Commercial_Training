...
namespace FirstConsoleApp
{
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            //All the methods present in the Abstract class can be accessed by inheriting it in derived class - By creating an object and accessing its methods in Main function.
